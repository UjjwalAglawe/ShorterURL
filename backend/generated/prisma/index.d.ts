...
export namespace Prisma {
  ...
  */
  ...
  export type urlOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "Mainurl" | "Suburl" | "Created_at", ExtArgs["result"]["url"]>
  ...
  interface urlFieldRefs {
    ...
    readonly Suburl: FieldRef<"url", 'String'>
  ...
  export type urlWhereInput = {
    ...
    Suburl?: StringFilter<"url"> | string
  ...
  export type urlScalarWhereWithAggregatesInput = {
    ...
    Suburl?: StringWithAggregatesFilter<"url"> | string
  ...
  export type urlUpdateInput = {
    ...
    Suburl?: StringFieldUpdateOperationsInput | string
